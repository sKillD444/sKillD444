...
| :--- | :--- | :--- |
| **[TowerOfSoul](https://github.com/sKillD444/TowerOfSoul)** | Đồ án LVTN - Tựa game phiêu lưu hành động. | `C++`, `Cocos2d-x` |
| **[Website Bán Nhạc Cụ](https://github.com/sKillD444/Web-b-n-nh-c-c-TTCN-)** | Web e-commerce hỗ trợ đặt hàng, thanh toán VNPAY và quản trị Admin. | `C#`, `ASP.NET`, `SQL Server` |
| **Quản Lý Tiệm Net** | Ứng dụng desktop quản lý máy trạm, dịch vụ và thông tin khách hàng. | `C#`, `WinForms`, `SQL Server` |
| **Live Mouse Control** | Hệ thống nhận diện cử chỉ ngón tay (AI) để điều khiển chuột máy tính. | `Python`, `MediaPipe`, `OpenCV` |
